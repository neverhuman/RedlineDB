...
coverage, benchmark, report, or sentinel producer; legacy scale/sentinel lanes
hard-fail and the `redlinedb-bench --bin sqlite_parity` producer subcommands
are disabled. Reference-shell capability skips are hard errors in the official
lane.

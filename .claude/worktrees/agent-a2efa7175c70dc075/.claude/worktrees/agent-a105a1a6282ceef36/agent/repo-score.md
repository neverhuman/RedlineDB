...
| Code shape and semantic surface | 12 | 0 | 0.00 | largest authored code file: crates/bench/src/bin/chaos_report.rs (1141 LOC); code file exceeds 500 LOC |
...
1. `medium` `shape` `.`
   ...
   Rerun: `just fast`
   Fingerprint: `sha256:e05fbf01a958cc499ede487201076641514d9f2be9c60d6ed37ecb1ba0222e4d`
   Evidence: largest authored code file: crates/bench/src/bin/chaos_report.rs (1141 LOC), code file exceeds 500 LOC, code file exceeds 1000 LOC, duplicate code block marker found
...
10. `high` `vibe` `crates/bench/src/bin/chaos_report.rs:126`
   Rule: `HLT-001-DEAD-MARKER`
   ...
   Rerun: `just fast`
   Fingerprint: `sha256:ae815ef84eba3c53951244aab42c40b74cf8ec88a5986fee672569b3e8473ab4`
   Evidence: crates/bench/src/bin/chaos_report.rs:126 env::current_dir().unwrap_or_else(|_| PathBuf::from("."))

...
| Code shape and semantic surface | 12 | 80 | 9.60 | largest authored code file: crates/kernel/src/index/cursor/raw.rs (494 LOC); most code files stay under 300 LOC |
...
1. `medium` `shape` `.`
   ...
   Rerun: `just fast`
   Fingerprint: `sha256:1f5de52055a0c6f79d0feecc29ba0d42db3619a16c973d413841e11480a5e118`
   Evidence: largest authored code file: crates/kernel/src/index/cursor/raw.rs (494 LOC), most code files stay under 300 LOC, copy-code advisory classes found: 29 (advisory only, no score impact), rust bad-behavior advisory signals: 1164

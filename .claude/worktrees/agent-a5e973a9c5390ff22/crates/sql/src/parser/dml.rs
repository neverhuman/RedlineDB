...
pub(crate) fn bind_insert(
    ...
    let columns = if insert.columns.is_empty() {
        ...
        // Phase-11 SQL-D A6: block explicit writes to generated
        // columns. SQLite emits "cannot INSERT into generated column
        // X"; mirror the error text fragment so callers can detect it.
        for ord in &ordinals {
...
pub(crate) fn bind_update(
    ...
    for assignment in update.assignments {
        ...
        // Phase-11 SQL-D A6: SQLite forbids `UPDATE SET <gencol> = ...`.

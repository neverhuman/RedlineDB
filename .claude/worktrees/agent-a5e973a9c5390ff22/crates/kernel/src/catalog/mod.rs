...
pub use ddl::{
    ...
    CreateIndexSpec, CreateTableSpec, DropIndexSpec, DropTableSpec, GeneratedColumnDef,
    IndexColumnSpec, IndexOrigin, TableConstraintSpec,
};
pub use expr::{
...
pub use schema::{
    ...
    GeneratedColumnKind, GeneratedColumnSpec, IndexDef, NamespaceDef, SchemaEpoch, SchemaSnapshot,

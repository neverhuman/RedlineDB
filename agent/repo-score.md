...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 6 | `crates/redlinedb-sqlx/src/bridge.rs:215-216, crates/redlinedb-sqlx/src/bridge.rs:294-295, crates/redlinedb-sqlx/src/bridge.rs:299-300, crates/redlinedb-sqlx/src/bridge.rs:323-324, crates/redlinedb-sqlx/src/bridge.rs:338-339, crates/redlinedb-sqlx/src/bridge.rs:353-354, crates/redlinedb-sqlx/src/bridge.rs:435-436` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 4 | `crates/redlinedb-sqlx/src/bridge.rs:201-202, crates/redlinedb-sqlx/src/bridge.rs:208-209, crates/redlinedb-sqlx/src/bridge.rs:280-281, crates/redlinedb-sqlx/src/bridge.rs:287-288` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 4 | `crates/redlinedb-sqlx/src/bridge.rs:241-242, crates/redlinedb-sqlx/src/bridge.rs:247-248, crates/redlinedb-sqlx/src/bridge.rs:371-372` | `same body appears under different names across files` |
...
| `ExactUnitSameName` | `Warning` | `rust` | 1 | 6 | `crates/redlinedb-sqlx/src/bridge.rs:215-216, crates/redlinedb-sqlx/src/bridge.rs:294-295` | `same-name semantic unit copied across multiple files` |
...
| `ExactUnitSameName` | `Warning` | `rust` | 1 | 4 | `crates/redlinedb-sqlx/src/bridge.rs:247-248, crates/redlinedb-sqlx/src/bridge.rs:371-372` | `same-name semantic unit copied across multiple files` |
...
| Code shape and semantic surface | 12 | 8 | 0.96 | largest authored code file: crates/redlinedb-sqlx/src/bridge.rs (774 LOC); code file exceeds 500 LOC |
...
1. `medium` `shape` `.`
   ...
   Rerun: `just fast`
   Fingerprint: `sha256:f971b148439597f5569a8380662c8f263bd67b7c9750ddc2935a9747775a259e`
   Evidence: largest authored code file: crates/redlinedb-sqlx/src/bridge.rs (774 LOC), code file exceeds 500 LOC, most code files stay under 300 LOC, copy-code advisory classes found: 57 (advisory only, no score impact)
...
4. `medium` `proof` `agent/repo-score.json:3486`
   ...
   Rerun: `just score`
   Fingerprint: `sha256:816d71117a0e271b13029859e7c60b3d9295045933a93f65eb93e854c93f50dd`
...
8. `high` `vibe` `crates/redlinedb-sqlx/src/lib.rs:15`
   Rule: `HLT-001-DEAD-MARKER`
   Check: `HLT-001-DEAD-MARKER:vibe` `hard` confidence `0.88`
   Route: TLR `Entropy`, lane `fast`, owner `public-rust-facade`
   Docs: `docs/audit-rubric.md#future-hostile-language-rule`
   ...
   Fix: remove or rename the marker, implement the intended behavior, model a typed unsupported state, or move docs/generated/vendor/product-copy text into an allowlisted context
   Rerun: `just fast`
   Fingerprint: `sha256:95ae7d9ab60f913d9e45975bce089370abfdd12e1c04802ab79f7c49986cfe90`
   Evidence: crates/redlinedb-sqlx/src/lib.rs:15, future-hostile/dead-language term `dummy` appears

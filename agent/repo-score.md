...
- Decision: `advisory`
- Minimum score: `85`
- Caps applied: `severe-duplication-in-product-code, authz-or-data-isolation-gap, rust-bad-behavior, ci-bad-behavior, ci-local-parity`
...
5. `high` `ci` `.github/workflows/ci.yml:12`
   Rule: `HLT-042-CI-LOCAL-PARITY`
   Check: `HLT-042-CI-LOCAL-PARITY:ci` `hard` confidence `0.95`
   Route: TLR `Verification`, lane `fast`, owner `ops`
   Docs: `docs/ci-local.md`
...
7. `high` `ci` `.github/workflows/jankurai.yml:12`
   Rule: `HLT-042-CI-LOCAL-PARITY`
   Check: `HLT-042-CI-LOCAL-PARITY:ci` `hard` confidence `0.95`
   Route: TLR `Verification`, lane `fast`, owner `ops`
   Docs: `docs/ci-local.md`
...
8. `high` `security` `.github/workflows/jankurai.yml:197`
   ...
   Rerun: `just security`
   Fingerprint: `sha256:8dd24ec84d47e9601edfeeb8f71831e6d99a881f0818ff9aa8ca45556c740349`
   Evidence: CI hardening gap detected
9. `high` `security` `.github/workflows/jankurai.yml:199`
   ...
   Rerun: `just security`
   Fingerprint: `sha256:e72c38115f18e5788d0b95babc8183989017cd3823ef4d3e89e3cace26aa7789`
   Evidence: detector=ci.security-scan.nonblocking, path=.github/workflows/jankurai.yml, line=199, proof_window=None, snippet=continue-on-error: true
...
11. `high` `generated` `agent/generated-zones.toml:1`
...
12. `high` `audit` `agent/owner-map.json:1`
...
17. `high` `security` `crates/bench/src/config.rs:293`
...
18. `high` `security` `crates/bench/src/process_metrics.rs:110`
...
19. `high` `security` `crates/ffi/src/error.rs:33`
   Rule: `HLT-029-RUST-BAD-BEHAVIOR`
   Check: `HLT-029-RUST-BAD-BEHAVIOR:security` `hard` confidence `0.95`
   Route: TLR `Security, secrets, agency`, lane `fast`, owner `tools`
   Docs: `docs/audit-rubric.md#top-level-risk-mapping`
...
20. `high` `security` `crates/ffi/src/lifecycle.rs:74`
   Rule: `HLT-029-RUST-BAD-BEHAVIOR`
   Check: `HLT-029-RUST-BAD-BEHAVIOR:security` `hard` confidence `0.95`
   Route: TLR `Security, secrets, agency`, lane `fast`, owner `tools`
   Docs: `docs/audit-rubric.md#top-level-risk-mapping`
...
21. `high` `security` `crates/ffi/src/snapshot.rs:87`
   Rule: `HLT-029-RUST-BAD-BEHAVIOR`
   Check: `HLT-029-RUST-BAD-BEHAVIOR:security` `hard` confidence `0.95`
   Route: TLR `Security, secrets, agency`, lane `fast`, owner `tools`
   Docs: `docs/audit-rubric.md#top-level-risk-mapping`
...
22. `high` `security` `crates/ffi/src/stmt.rs:160`
   Rule: `HLT-029-RUST-BAD-BEHAVIOR`
   Check: `HLT-029-RUST-BAD-BEHAVIOR:security` `hard` confidence `0.95`
   Route: TLR `Security, secrets, agency`, lane `fast`, owner `tools`
   Docs: `docs/audit-rubric.md#top-level-risk-mapping`
...
23. `high` `security` `crates/ffi/src/util.rs:146`
   Rule: `HLT-029-RUST-BAD-BEHAVIOR`
   Check: `HLT-029-RUST-BAD-BEHAVIOR:security` `hard` confidence `0.95`
   Route: TLR `Security, secrets, agency`, lane `fast`, owner `tools`
   Docs: `docs/audit-rubric.md#top-level-risk-mapping`
...
24. `high` `copy-code` `crates/sql/src/exec/tail_rows.rs:147`
...
25. `medium` `release` `docs/testing.md`
...
12. `high` `HLT-020-CI-HARDENING-GAP` `.github/workflows/jankurai.yml` - remove the nonblocking override and let the security or proof job fail so the CI gate actually proves the change
   Route: `Security, secrets, agency`/`security`
13. `high` `HLT-034-CI-BAD-BEHAVIOR` `.github/workflows/jankurai.yml` - remove the non-blocking override so scan failures stop the pipeline
   Route: `Security, secrets, agency`/`security`
14. `high` `HLT-029-RUST-BAD-BEHAVIOR` `crates/bench/src/process_metrics.rs` - construct the type with a valid initializer instead of zeroing it
   Route: `Security, secrets, agency`/`fast`
15. `high` `HLT-029-RUST-BAD-BEHAVIOR` `crates/ffi/src/error.rs` - use the matching constructor/destructor pair or add a documented ownership proof
   Route: `Security, secrets, agency`/`fast`
16. `high` `HLT-029-RUST-BAD-BEHAVIOR` `crates/ffi/src/lifecycle.rs` - use the matching constructor/destructor pair or add a documented ownership proof
   Route: `Security, secrets, agency`/`fast`
17. `high` `HLT-029-RUST-BAD-BEHAVIOR` `crates/ffi/src/snapshot.rs` - use the matching constructor/destructor pair or add a documented ownership proof
   Route: `Security, secrets, agency`/`fast`
18. `high` `HLT-029-RUST-BAD-BEHAVIOR` `crates/ffi/src/stmt.rs` - use the matching constructor/destructor pair or add a documented ownership proof
   Route: `Security, secrets, agency`/`fast`
19. `high` `HLT-029-RUST-BAD-BEHAVIOR` `crates/ffi/src/util.rs` - use the matching constructor/destructor pair or add a documented ownership proof
   Route: `Security, secrets, agency`/`fast`
20. `high` `HLT-043-COPY-PASTE-BAD-BEHAVIOR` `crates/sql/src/exec/tail_rows.rs` - keep the named unit in one owner and call it from the other sites
...
21. `medium` `HLT-001-DEAD-MARKER` `.` - split large or ambiguous authored code into smaller semantic modules with focused tests
   Route: `Entropy`/`fast`
22. `medium` `HLT-016-SUPPLY-CHAIN-DRIFT` `.github/workflows/jankurai.yml` - wire secret, dependency, provenance, and workflow scans into an operational CI lane
   Route: `Security, secrets, agency`/`security`

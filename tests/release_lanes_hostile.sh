...
jq -n \
    ...
    '{
      ...
      build_inputs:{
        ...
        cargo_config_sha256:$sixty_four,cargo_lock_sha256:$sixty_four,
        cargo_registry_source:"/registry",
        cargo_registry_receipt_sha256:$sixty_four,
        cargo_stage_tool_sha256:$sixty_four,

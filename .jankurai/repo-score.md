...
2. `medium` `HLT-027-HUMAN-REVIEW-EVIDENCE-GAP` `ops/ci/interaction-volume-adversarial-test.sh` - attach raw CI logs, review receipts, and replayable commands instead of accepting claims or summaries
   Route: `Repair`/`audit`

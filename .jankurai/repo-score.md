...
- Duplicate volume: lines=`165` tokens=`465` bytes=`4467`
...
1. `medium` `shape` `.`
   ...
   Rerun: `just fast`
   Fingerprint: `sha256:0bd5a54cce57bd1ebcf70811012a06c17e035206f3f01f6c5209805d53623432`

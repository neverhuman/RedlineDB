...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 3 | `crates/sql/src/rql.rs:1579-1580, crates/sql/src/rql.rs:1664-1665, crates/sql/src/rql.rs:1827-1828, crates/sql/src/rql.rs:1851-1852` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 7 | `crates/sql/src/rql.rs:1685-1686, crates/sql/src/rql.rs:1731-1732` | `same body appears under different names across files` |

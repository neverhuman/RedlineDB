...
- Status: `review` hard=`0` warning=`121` files=`358`
- Policy: min-lines=`10` min-tokens=`100` max-findings=`50` include-tests=`false` strict=`false`
- Duplicate volume: lines=`235` tokens=`732` bytes=`6766`

- Notes:
  - hard classes are limited to exact active-source file matches and substantial exact same-name units
  - warning classes include same-body different-name units and token/block duplication
  - tests, fixtures, stories, config, Docker, and migrations are omitted unless --include-tests is set
  - showing the top 50 classes and omitting 71 lower-ranked classes
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 3 | 16 | `crates/sql/src/exec/expr/json_dispatch.rs:732-735, crates/sql/src/exec/expr/scalar/value.rs:556-559, crates/sql/src/exec/expr/scalar/value.rs:710-713` | `same body appears under different names across files` |
| `ExactUnitSameName` | `Warning` | `rust` | 6 | 21 | `crates/cli/src/shellzero.rs:217-223, crates/redlinedb-lite/src/shellzero.rs:194-200` | `same-name semantic unit copied across multiple files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 4 | `crates/sql/src/parser.rs:1123-1124, crates/sql/src/parser.rs:1146-1147, crates/sql/src/parser.rs:2801-2802, crates/sql/src/parser.rs:2865-2866, crates/sql/src/parser.rs:3326-3327` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 4 | 12 | `crates/sql/src/exec/expr/json_dispatch.rs:62-66, crates/sql/src/exec/expr/json_dispatch.rs:771-775` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 3 | `crates/sql/src/rql.rs:1538-1539, crates/sql/src/rql.rs:1623-1624, crates/sql/src/rql.rs:1786-1787, crates/sql/src/rql.rs:1810-1811` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 3 | 6 | `crates/sql/src/parser.rs:1188-1191, crates/sql/src/parser.rs:1216-1219` | `same body appears under different names across files` |
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 2 | `crates/sql/src/exec/expr/program.rs:970-971, crates/sql/src/exec/expr/program.rs:1015-1016, crates/sql/src/exec/expr/program.rs:1030-1031, crates/sql/src/exec/expr/program.rs:1084-1085` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 2 | `crates/cli/src/dot/mod.rs:358-359, crates/cli/src/shellzero.rs:153-154, crates/redlinedb-lite/src/shellzero.rs:132-133` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 7 | `crates/sql/src/rql.rs:1644-1645, crates/sql/src/rql.rs:1690-1691` | `same body appears under different names across files` |
...
| Code shape and semantic surface | 12 | 45 | 5.40 | largest authored code file: crates/sql/src/parser.rs (5016 LOC); code file exceeds 500 LOC |
...
1. `medium` `shape` `.`
   ...
   Rerun: `just fast`
   Fingerprint: `sha256:9b32ac9cce05c3cfce357db872dbafdef129d4069222ce661816f53cf5eaa618`
   Evidence: largest authored code file: crates/sql/src/parser.rs (5016 LOC), code file exceeds 500 LOC, code file exceeds 1000 LOC, most code files stay under 300 LOC

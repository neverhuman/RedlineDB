...
- Status: `review` hard=`0` warning=`119` files=`357`
- Policy: min-lines=`10` min-tokens=`100` max-findings=`50` include-tests=`false` strict=`false`
- Duplicate volume: lines=`233` tokens=`722` bytes=`6660`
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 4 | `crates/sql/src/parser.rs:1123-1124, crates/sql/src/parser.rs:1146-1147, crates/sql/src/parser.rs:2801-2802, crates/sql/src/parser.rs:2865-2866, crates/sql/src/parser.rs:3225-3226, crates/sql/src/parser.rs:3321-3322` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 7 | `crates/sql/src/connection/database.rs:557-558, crates/sql/src/connection/database.rs:571-572` | `same body appears under different names across files` |
...
| Code shape and semantic surface | 12 | 45 | 5.40 | largest authored code file: crates/sql/src/parser.rs (4988 LOC); code file exceeds 500 LOC |
...
1. `medium` `shape` `.`
   ...
   Rerun: `just fast`
   Fingerprint: `sha256:d2b4de7e04619d7b1e7cde95656babaeef14e961ed4eb39e7771184840ee855c`
   Evidence: largest authored code file: crates/sql/src/parser.rs (4988 LOC), code file exceeds 500 LOC, code file exceeds 1000 LOC, most code files stay under 300 LOC

...
- Decision: `fail`
- Minimum score: `85`
- Caps applied: `input-boundary-gap, ci-local-parity`
...
- Status: `review` hard=`0` warning=`164` files=`452`
- Policy: min-lines=`10` min-tokens=`100` max-findings=`50` include-tests=`false` strict=`false`
- Duplicate volume: lines=`310` tokens=`960` bytes=`8924`
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 10 | 24 | `crates/sql/src/exec/expr/predicate.rs:336-346, crates/sql/src/parser/rewrite/pg.rs:1283-1293` | `same body appears under different names across files` |
| `ExactUnitDifferentName` | `Warning` | `rust` | 3 | 6 | `crates/sql/src/parser.rs:303-306, crates/sql/src/parser.rs:324-327, crates/sql/src/parser/rewrite/sqlite.rs:988-991, crates/sql/src/parser/rewrite/sqlite.rs:1009-1012` | `same body appears under different names across files` |
| `ExactUnitDifferentName` | `Warning` | `rust` | 2 | 5 | `crates/kernel/src/json/path_bytecode.rs:138-140, crates/sql/src/json/jsonb.rs:1062-1064, crates/sql/src/parser/rewrite/grouping.rs:772-774, crates/sql/src/parser/rewrite/pg.rs:1325-1327, crates/sql/src/parser/rewrite/sqlite_tail.rs:166-168` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 5 | 15 | `crates/sql/src/exec/mod.rs:1588-1593, crates/sql/src/exec/mod.rs:1603-1608` | `same body appears under different names across files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 4 | `crates/sql/src/parser.rs:347-348, crates/sql/src/parser.rs:372-373, crates/sql/src/parser/rewrite/sqlite.rs:1032-1033, crates/sql/src/parser/rewrite/sqlite.rs:1057-1058` | `same body appears under different names across files` |
...
| `ExactUnitSameName` | `Warning` | `rust` | 3 | 6 | `crates/sql/src/parser.rs:303-306, crates/sql/src/parser/rewrite/sqlite.rs:988-991` | `same-name semantic unit copied across multiple files` |
| `ExactUnitSameName` | `Warning` | `rust` | 3 | 6 | `crates/sql/src/parser.rs:324-327, crates/sql/src/parser/rewrite/sqlite.rs:1009-1012` | `same-name semantic unit copied across multiple files` |
...
| `ExactUnitDifferentName` | `Warning` | `rust` | 1 | 1 | `crates/cli/src/dot/mod.rs:499-500, crates/sql/src/exec/expr/program.rs:1187-1188, crates/sql/src/json/scalar.rs:766-767, crates/sql/src/parser/rewrite/sqlite.rs:1109-1110` | `same body appears under different names across files` |
...
| Code shape and semantic surface | 12 | 45 | 5.40 | largest authored code file: crates/sql/src/exec/select_top.rs (1935 LOC); code file exceeds 500 LOC |
...
1. `medium` `shape` `.`
   ...
   Rerun: `just fast`
   Fingerprint: `sha256:84c3fa13294d5397fd7febb36b915a07b45ea63c7d1be754dfa468316d9ea5c5`
   Evidence: largest authored code file: crates/sql/src/exec/select_top.rs (1935 LOC), code file exceeds 500 LOC, code file exceeds 1000 LOC, most code files stay under 300 LOC
2. `high` `ci` `.github/workflows/benchmark.yml:34`
   ...
   Rerun: `just fast`
   Fingerprint: `sha256:ab6341a6c919a73e050593a3c3a3740131c0333f71d09d6a2548535f3833a6f6`
   Evidence: detector=ci.local-parity.workflow-not-thin, path=.github/workflows/benchmark.yml, line=34, proof_window=None, snippet=jobs:
...
4. `high` `security` `crates/sql/src/parser/rewrite/grouping.rs:635`
   ...
   Rerun: `just security`
   Fingerprint: `sha256:0236f23db4886f8569555d7e33ff1df7a79a0b1f71837141546572f2f842f6ed`
   Evidence: let body_after_select = &trimmed[select_offset + "SELECT ".len()..];
...
1. `high` `HLT-042-CI-LOCAL-PARITY` `.github/workflows/benchmark.yml` - extract the workflow steps into ops/ci/<lane>.sh and call them with `bash ops/ci/<lane>.sh`
...
2. `medium` `HLT-018-PERF-CONCURRENCY-DRIFT` `Justfile` - add fast deterministic build/test targets, caches, and narrow proof lanes for agent iteration
   Route: `Verification`/`fast`
3. `high` `HLT-023-INPUT-BOUNDARY-GAP` `crates/sql/src/parser/rewrite/grouping.rs` - replace unsafe sinks with typed schemas, parameterized APIs, allowlists, or sandboxed execution plus negative tests

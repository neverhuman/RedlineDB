...
- Jankurai receipt hostiles: `bash tests/jankurai_evidence_hostile.sh`
  (closed schema/head/non-vacuity/verdict plus coverage, mutation, and
  negative-proof rejection)

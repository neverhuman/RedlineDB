...
sign_bundle() {
  ...
  if [[ -z "${JERYU_SIGNRAIL_ED25519_SEED:-${SIGNRAIL_ED25519_SEED:-}}" ]]; then
    ...
    printf '{"schema_version":"redline-testing.artifact-support.signrail/v1","status":"unsigned","reason":"no signrail ed25519 seed in the environment","bundle":"%s","bundle_sha256":"%s"}\n' \

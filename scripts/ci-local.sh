...
usage: scripts/ci-local.sh {required|pr-ci|security|score|contract-drift|artifact-support|jankurai|audit|release|doctor}
  ...
  score    enforce the governed Jankurai score and ratchet
  contract-drift verify release schemas, package, and manifest integrity
  artifact-support build commit-bound unsigned review evidence

...
pub fn execute_prepared(
    ...
    match &template.kind {
        ...
        // Track J: register a Postgres-style schema name on the connection.
        ...
        PreparedKind::CreateSchema { name, if_not_exists } => {
        ...
        // Track J: SHOW <name>. Routes recognised names through a single-row
        // static-row select source so the caller sees a row containing the
        // current value. Unknown names yield an empty string.

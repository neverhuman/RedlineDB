...
/// placeholder DateTime (julian-day 0) carrying an `out_of_range` flag.
/// Downstream modifier/format logic uses the flag to either rescue the
/// value (e.g. `'unixepoch'`, `'utc'`) or to surface NULL.

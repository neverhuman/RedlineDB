...
const GENERATED_BY: &str = "Generated by: redlinedb-bench sqlite_parity jankurai-compare";
const GENERATED_SOURCE: &str =
    "Source: .jankurai/repo-score.json; target/sqlite-jankurai/repo-score.json";
const GENERATED_COMMAND: &str = "Command: just sqlite-jankurai-compare";
const DO_NOT_EDIT: &str = "DO NOT EDIT BY HAND.";
const REPORT_GENERATED_BY: &str = "redlinedb-bench sqlite_parity report";
const REPORT_REGEN_COMMAND: &str = "just sqlite-parity-report-update";
...
fn generated_command() -> String {
    GENERATED_COMMAND.to_owned()
}

fn do_not_edit() -> String {

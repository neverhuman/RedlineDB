...
// Source: SQLITE_PARITY_1092_INDEX_SCHEMA_PRAGMA_025

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1092,
        folder: r"SQLITE_PARITY_1092_INDEX_SCHEMA_PRAGMA_025",
        name: r"INDEX_SCHEMA_PRAGMA_025",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_025.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',25),(2,'two',26),(3,'three',27),(4,'four',28);

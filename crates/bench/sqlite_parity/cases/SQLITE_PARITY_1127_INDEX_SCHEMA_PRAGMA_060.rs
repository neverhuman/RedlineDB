...
// Source: SQLITE_PARITY_1127_INDEX_SCHEMA_PRAGMA_060

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1127,
        folder: r"SQLITE_PARITY_1127_INDEX_SCHEMA_PRAGMA_060",
        name: r"INDEX_SCHEMA_PRAGMA_060",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_060.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',60),(2,'two',61),(3,'three',62),(4,'four',63);

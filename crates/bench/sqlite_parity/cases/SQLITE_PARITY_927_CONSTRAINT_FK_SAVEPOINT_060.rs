...
// Source: SQLITE_PARITY_927_CONSTRAINT_FK_SAVEPOINT_060

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 927,
        folder: r"SQLITE_PARITY_927_CONSTRAINT_FK_SAVEPOINT_060",
        name: r"CONSTRAINT_FK_SAVEPOINT_060",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_060.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

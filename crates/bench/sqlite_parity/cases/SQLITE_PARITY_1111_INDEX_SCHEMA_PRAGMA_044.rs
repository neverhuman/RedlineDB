...
// Source: SQLITE_PARITY_1111_INDEX_SCHEMA_PRAGMA_044

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1111,
        folder: r"SQLITE_PARITY_1111_INDEX_SCHEMA_PRAGMA_044",
        name: r"INDEX_SCHEMA_PRAGMA_044",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_044.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',44),(2,'two',45),(3,'three',46),(4,'four',47);

...
// Source: SQLITE_PARITY_397_DML_WHERE_ORDER_LIMIT_010

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 397,
        folder: r"SQLITE_PARITY_397_DML_WHERE_ORDER_LIMIT_010",
        name: r"DML_WHERE_ORDER_LIMIT_010",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_010.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

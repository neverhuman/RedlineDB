...
// Source: SQLITE_PARITY_433_DML_WHERE_ORDER_LIMIT_046

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 433,
        folder: r"SQLITE_PARITY_433_DML_WHERE_ORDER_LIMIT_046",
        name: r"DML_WHERE_ORDER_LIMIT_046",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_046.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_453_DML_WHERE_ORDER_LIMIT_066

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 453,
        folder: r"SQLITE_PARITY_453_DML_WHERE_ORDER_LIMIT_066",
        name: r"DML_WHERE_ORDER_LIMIT_066",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_066.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

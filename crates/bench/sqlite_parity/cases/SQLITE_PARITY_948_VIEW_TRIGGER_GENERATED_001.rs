...
// Source: SQLITE_PARITY_948_VIEW_TRIGGER_GENERATED_001

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 948,
        folder: r"SQLITE_PARITY_948_VIEW_TRIGGER_GENERATED_001",
        name: r"VIEW_TRIGGER_GENERATED_001",
        category: r"GEN_SQL_VIEW_TRIGGER",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for VIEW_TRIGGER_GENERATED_001.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
CREATE VIEW v AS SELECT id, y FROM t WHERE y >= 2;

...
// Source: SQLITE_PARITY_1069_INDEX_SCHEMA_PRAGMA_002

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1069,
        folder: r"SQLITE_PARITY_1069_INDEX_SCHEMA_PRAGMA_002",
        name: r"INDEX_SCHEMA_PRAGMA_002",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_002.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',2),(2,'two',3),(3,'three',4),(4,'four',5);

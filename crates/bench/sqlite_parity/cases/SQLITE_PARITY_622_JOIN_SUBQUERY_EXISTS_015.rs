...
// Source: SQLITE_PARITY_622_JOIN_SUBQUERY_EXISTS_015

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 622,
        folder: r"SQLITE_PARITY_622_JOIN_SUBQUERY_EXISTS_015",
        name: r"JOIN_SUBQUERY_EXISTS_015",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_015.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_1103_INDEX_SCHEMA_PRAGMA_036

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1103,
        folder: r"SQLITE_PARITY_1103_INDEX_SCHEMA_PRAGMA_036",
        name: r"INDEX_SCHEMA_PRAGMA_036",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_036.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',36),(2,'two',37),(3,'three',38),(4,'four',39);

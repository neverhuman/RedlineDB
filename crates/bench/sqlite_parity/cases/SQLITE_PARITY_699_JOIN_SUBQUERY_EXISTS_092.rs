...
// Source: SQLITE_PARITY_699_JOIN_SUBQUERY_EXISTS_092

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 699,
        folder: r"SQLITE_PARITY_699_JOIN_SUBQUERY_EXISTS_092",
        name: r"JOIN_SUBQUERY_EXISTS_092",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_092.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

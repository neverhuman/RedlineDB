...
// Source: SQLITE_PARITY_452_DML_WHERE_ORDER_LIMIT_065

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 452,
        folder: r"SQLITE_PARITY_452_DML_WHERE_ORDER_LIMIT_065",
        name: r"DML_WHERE_ORDER_LIMIT_065",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_065.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

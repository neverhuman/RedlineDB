...
// Source: SQLITE_PARITY_1124_INDEX_SCHEMA_PRAGMA_057

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1124,
        folder: r"SQLITE_PARITY_1124_INDEX_SCHEMA_PRAGMA_057",
        name: r"INDEX_SCHEMA_PRAGMA_057",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_057.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',57),(2,'two',58),(3,'three',59),(4,'four',60);

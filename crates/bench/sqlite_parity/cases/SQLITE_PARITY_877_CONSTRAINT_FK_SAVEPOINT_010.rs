...
// Source: SQLITE_PARITY_877_CONSTRAINT_FK_SAVEPOINT_010

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 877,
        folder: r"SQLITE_PARITY_877_CONSTRAINT_FK_SAVEPOINT_010",
        name: r"CONSTRAINT_FK_SAVEPOINT_010",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_010.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

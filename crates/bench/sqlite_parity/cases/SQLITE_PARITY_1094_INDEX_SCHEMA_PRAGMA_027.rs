...
// Source: SQLITE_PARITY_1094_INDEX_SCHEMA_PRAGMA_027

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1094,
        folder: r"SQLITE_PARITY_1094_INDEX_SCHEMA_PRAGMA_027",
        name: r"INDEX_SCHEMA_PRAGMA_027",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_027.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',27),(2,'two',28),(3,'three',29),(4,'four',30);

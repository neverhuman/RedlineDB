...
// Source: SQLITE_PARITY_880_CONSTRAINT_FK_SAVEPOINT_013

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 880,
        folder: r"SQLITE_PARITY_880_CONSTRAINT_FK_SAVEPOINT_013",
        name: r"CONSTRAINT_FK_SAVEPOINT_013",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_013.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

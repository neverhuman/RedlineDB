...
// Source: SQLITE_PARITY_1115_INDEX_SCHEMA_PRAGMA_048

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1115,
        folder: r"SQLITE_PARITY_1115_INDEX_SCHEMA_PRAGMA_048",
        name: r"INDEX_SCHEMA_PRAGMA_048",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_048.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',48),(2,'two',49),(3,'three',50),(4,'four',51);

...
// Source: SQLITE_PARITY_937_CONSTRAINT_FK_SAVEPOINT_070

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 937,
        folder: r"SQLITE_PARITY_937_CONSTRAINT_FK_SAVEPOINT_070",
        name: r"CONSTRAINT_FK_SAVEPOINT_070",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_070.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_680_JOIN_SUBQUERY_EXISTS_073

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 680,
        folder: r"SQLITE_PARITY_680_JOIN_SUBQUERY_EXISTS_073",
        name: r"JOIN_SUBQUERY_EXISTS_073",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_073.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

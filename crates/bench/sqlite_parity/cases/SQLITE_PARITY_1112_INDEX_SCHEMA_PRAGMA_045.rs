...
// Source: SQLITE_PARITY_1112_INDEX_SCHEMA_PRAGMA_045

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1112,
        folder: r"SQLITE_PARITY_1112_INDEX_SCHEMA_PRAGMA_045",
        name: r"INDEX_SCHEMA_PRAGMA_045",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_045.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',45),(2,'two',46),(3,'three',47),(4,'four',48);

...
// Source: SQLITE_PARITY_685_JOIN_SUBQUERY_EXISTS_078

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 685,
        folder: r"SQLITE_PARITY_685_JOIN_SUBQUERY_EXISTS_078",
        name: r"JOIN_SUBQUERY_EXISTS_078",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_078.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

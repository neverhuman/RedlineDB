...
// Source: SQLITE_PARITY_1079_INDEX_SCHEMA_PRAGMA_012

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1079,
        folder: r"SQLITE_PARITY_1079_INDEX_SCHEMA_PRAGMA_012",
        name: r"INDEX_SCHEMA_PRAGMA_012",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_012.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',12),(2,'two',13),(3,'three',14),(4,'four',15);

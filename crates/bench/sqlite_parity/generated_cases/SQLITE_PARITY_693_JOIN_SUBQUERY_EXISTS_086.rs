...
// Source: SQLITE_PARITY_693_JOIN_SUBQUERY_EXISTS_086

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 693,
        folder: r"SQLITE_PARITY_693_JOIN_SUBQUERY_EXISTS_086",
        name: r"JOIN_SUBQUERY_EXISTS_086",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_086.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

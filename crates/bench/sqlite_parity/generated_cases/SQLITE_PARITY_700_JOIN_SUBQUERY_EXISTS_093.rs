...
// Source: SQLITE_PARITY_700_JOIN_SUBQUERY_EXISTS_093

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 700,
        folder: r"SQLITE_PARITY_700_JOIN_SUBQUERY_EXISTS_093",
        name: r"JOIN_SUBQUERY_EXISTS_093",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_093.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

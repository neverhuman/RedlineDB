...
// Source: SQLITE_PARITY_1071_INDEX_SCHEMA_PRAGMA_004

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1071,
        folder: r"SQLITE_PARITY_1071_INDEX_SCHEMA_PRAGMA_004",
        name: r"INDEX_SCHEMA_PRAGMA_004",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_004.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',4),(2,'two',5),(3,'three',6),(4,'four',7);

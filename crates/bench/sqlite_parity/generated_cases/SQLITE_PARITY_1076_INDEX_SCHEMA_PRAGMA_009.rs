...
// Source: SQLITE_PARITY_1076_INDEX_SCHEMA_PRAGMA_009

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1076,
        folder: r"SQLITE_PARITY_1076_INDEX_SCHEMA_PRAGMA_009",
        name: r"INDEX_SCHEMA_PRAGMA_009",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_009.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',9),(2,'two',10),(3,'three',11),(4,'four',12);

...
// Source: SQLITE_PARITY_911_CONSTRAINT_FK_SAVEPOINT_044

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 911,
        folder: r"SQLITE_PARITY_911_CONSTRAINT_FK_SAVEPOINT_044",
        name: r"CONSTRAINT_FK_SAVEPOINT_044",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_044.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

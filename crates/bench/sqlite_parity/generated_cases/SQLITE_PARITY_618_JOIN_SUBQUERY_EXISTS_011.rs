...
// Source: SQLITE_PARITY_618_JOIN_SUBQUERY_EXISTS_011

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 618,
        folder: r"SQLITE_PARITY_618_JOIN_SUBQUERY_EXISTS_011",
        name: r"JOIN_SUBQUERY_EXISTS_011",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_011.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_899_CONSTRAINT_FK_SAVEPOINT_032

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 899,
        folder: r"SQLITE_PARITY_899_CONSTRAINT_FK_SAVEPOINT_032",
        name: r"CONSTRAINT_FK_SAVEPOINT_032",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_032.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

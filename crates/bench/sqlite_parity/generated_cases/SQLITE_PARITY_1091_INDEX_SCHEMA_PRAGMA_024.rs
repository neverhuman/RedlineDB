...
// Source: SQLITE_PARITY_1091_INDEX_SCHEMA_PRAGMA_024

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1091,
        folder: r"SQLITE_PARITY_1091_INDEX_SCHEMA_PRAGMA_024",
        name: r"INDEX_SCHEMA_PRAGMA_024",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_024.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',24),(2,'two',25),(3,'three',26),(4,'four',27);

...
// Source: SQLITE_PARITY_893_CONSTRAINT_FK_SAVEPOINT_026

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 893,
        folder: r"SQLITE_PARITY_893_CONSTRAINT_FK_SAVEPOINT_026",
        name: r"CONSTRAINT_FK_SAVEPOINT_026",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_026.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_406_DML_WHERE_ORDER_LIMIT_019

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 406,
        folder: r"SQLITE_PARITY_406_DML_WHERE_ORDER_LIMIT_019",
        name: r"DML_WHERE_ORDER_LIMIT_019",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_019.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

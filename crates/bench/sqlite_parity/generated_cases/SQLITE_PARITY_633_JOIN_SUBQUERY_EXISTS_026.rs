...
// Source: SQLITE_PARITY_633_JOIN_SUBQUERY_EXISTS_026

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 633,
        folder: r"SQLITE_PARITY_633_JOIN_SUBQUERY_EXISTS_026",
        name: r"JOIN_SUBQUERY_EXISTS_026",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_026.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

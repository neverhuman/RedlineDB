...
// Source: SQLITE_PARITY_874_CONSTRAINT_FK_SAVEPOINT_007

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 874,
        folder: r"SQLITE_PARITY_874_CONSTRAINT_FK_SAVEPOINT_007",
        name: r"CONSTRAINT_FK_SAVEPOINT_007",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_007.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

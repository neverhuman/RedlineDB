...
// Source: SQLITE_PARITY_413_DML_WHERE_ORDER_LIMIT_026

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 413,
        folder: r"SQLITE_PARITY_413_DML_WHERE_ORDER_LIMIT_026",
        name: r"DML_WHERE_ORDER_LIMIT_026",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_026.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

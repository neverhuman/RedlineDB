...
// Source: SQLITE_PARITY_1090_INDEX_SCHEMA_PRAGMA_023

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1090,
        folder: r"SQLITE_PARITY_1090_INDEX_SCHEMA_PRAGMA_023",
        name: r"INDEX_SCHEMA_PRAGMA_023",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_023.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',23),(2,'two',24),(3,'three',25),(4,'four',26);

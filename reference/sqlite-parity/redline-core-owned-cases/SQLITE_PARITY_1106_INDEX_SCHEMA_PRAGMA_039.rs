...
// Source: SQLITE_PARITY_1106_INDEX_SCHEMA_PRAGMA_039

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1106,
        folder: r"SQLITE_PARITY_1106_INDEX_SCHEMA_PRAGMA_039",
        name: r"INDEX_SCHEMA_PRAGMA_039",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_039.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',39),(2,'two',40),(3,'three',41),(4,'four',42);

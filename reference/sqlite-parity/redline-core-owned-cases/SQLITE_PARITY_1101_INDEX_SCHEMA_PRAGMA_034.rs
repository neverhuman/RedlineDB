...
// Source: SQLITE_PARITY_1101_INDEX_SCHEMA_PRAGMA_034

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1101,
        folder: r"SQLITE_PARITY_1101_INDEX_SCHEMA_PRAGMA_034",
        name: r"INDEX_SCHEMA_PRAGMA_034",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_034.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',34),(2,'two',35),(3,'three',36),(4,'four',37);

...
// Source: SQLITE_PARITY_432_DML_WHERE_ORDER_LIMIT_045

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 432,
        folder: r"SQLITE_PARITY_432_DML_WHERE_ORDER_LIMIT_045",
        name: r"DML_WHERE_ORDER_LIMIT_045",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_045.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

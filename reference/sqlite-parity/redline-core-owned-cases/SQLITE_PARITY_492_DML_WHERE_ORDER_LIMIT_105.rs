...
// Source: SQLITE_PARITY_492_DML_WHERE_ORDER_LIMIT_105

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 492,
        folder: r"SQLITE_PARITY_492_DML_WHERE_ORDER_LIMIT_105",
        name: r"DML_WHERE_ORDER_LIMIT_105",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_105.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

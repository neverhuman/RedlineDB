...
// Source: SQLITE_PARITY_1113_INDEX_SCHEMA_PRAGMA_046

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1113,
        folder: r"SQLITE_PARITY_1113_INDEX_SCHEMA_PRAGMA_046",
        name: r"INDEX_SCHEMA_PRAGMA_046",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_046.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',46),(2,'two',47),(3,'three',48),(4,'four',49);

...
// Source: SQLITE_PARITY_938_CONSTRAINT_FK_SAVEPOINT_071

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 938,
        folder: r"SQLITE_PARITY_938_CONSTRAINT_FK_SAVEPOINT_071",
        name: r"CONSTRAINT_FK_SAVEPOINT_071",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_071.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

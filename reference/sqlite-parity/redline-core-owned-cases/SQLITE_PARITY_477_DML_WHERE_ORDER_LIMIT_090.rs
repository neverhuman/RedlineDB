...
// Source: SQLITE_PARITY_477_DML_WHERE_ORDER_LIMIT_090

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 477,
        folder: r"SQLITE_PARITY_477_DML_WHERE_ORDER_LIMIT_090",
        name: r"DML_WHERE_ORDER_LIMIT_090",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_090.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

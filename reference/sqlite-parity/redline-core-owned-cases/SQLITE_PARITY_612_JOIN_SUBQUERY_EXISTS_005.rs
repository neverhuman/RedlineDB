...
// Source: SQLITE_PARITY_612_JOIN_SUBQUERY_EXISTS_005

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 612,
        folder: r"SQLITE_PARITY_612_JOIN_SUBQUERY_EXISTS_005",
        name: r"JOIN_SUBQUERY_EXISTS_005",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_005.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

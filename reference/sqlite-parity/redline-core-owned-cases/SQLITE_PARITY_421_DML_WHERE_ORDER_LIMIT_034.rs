...
// Source: SQLITE_PARITY_421_DML_WHERE_ORDER_LIMIT_034

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 421,
        folder: r"SQLITE_PARITY_421_DML_WHERE_ORDER_LIMIT_034",
        name: r"DML_WHERE_ORDER_LIMIT_034",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_034.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

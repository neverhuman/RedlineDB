...
// Source: SQLITE_PARITY_1095_INDEX_SCHEMA_PRAGMA_028

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1095,
        folder: r"SQLITE_PARITY_1095_INDEX_SCHEMA_PRAGMA_028",
        name: r"INDEX_SCHEMA_PRAGMA_028",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_028.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',28),(2,'two',29),(3,'three',30),(4,'four',31);

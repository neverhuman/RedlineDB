...
// Source: SQLITE_PARITY_1110_INDEX_SCHEMA_PRAGMA_043

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1110,
        folder: r"SQLITE_PARITY_1110_INDEX_SCHEMA_PRAGMA_043",
        name: r"INDEX_SCHEMA_PRAGMA_043",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_043.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',43),(2,'two',44),(3,'three',45),(4,'four',46);

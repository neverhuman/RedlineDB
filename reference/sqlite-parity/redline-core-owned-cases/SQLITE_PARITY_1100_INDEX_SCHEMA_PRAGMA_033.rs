...
// Source: SQLITE_PARITY_1100_INDEX_SCHEMA_PRAGMA_033

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1100,
        folder: r"SQLITE_PARITY_1100_INDEX_SCHEMA_PRAGMA_033",
        name: r"INDEX_SCHEMA_PRAGMA_033",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_033.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',33),(2,'two',34),(3,'three',35),(4,'four',36);

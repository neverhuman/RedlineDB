...
// Source: SQLITE_PARITY_416_DML_WHERE_ORDER_LIMIT_029

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 416,
        folder: r"SQLITE_PARITY_416_DML_WHERE_ORDER_LIMIT_029",
        name: r"DML_WHERE_ORDER_LIMIT_029",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_029.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_486_DML_WHERE_ORDER_LIMIT_099

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 486,
        folder: r"SQLITE_PARITY_486_DML_WHERE_ORDER_LIMIT_099",
        name: r"DML_WHERE_ORDER_LIMIT_099",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_099.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
",
        expected_exit: 0,
        compare_stdout: true,
        expected_stdout: Some(r"7|1|8|12
"),

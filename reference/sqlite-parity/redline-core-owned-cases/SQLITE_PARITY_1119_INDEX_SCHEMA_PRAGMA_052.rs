...
// Source: SQLITE_PARITY_1119_INDEX_SCHEMA_PRAGMA_052

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1119,
        folder: r"SQLITE_PARITY_1119_INDEX_SCHEMA_PRAGMA_052",
        name: r"INDEX_SCHEMA_PRAGMA_052",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_052.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',52),(2,'two',53),(3,'three',54),(4,'four',55);

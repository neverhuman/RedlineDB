...
// Source: SQLITE_PARITY_661_JOIN_SUBQUERY_EXISTS_054

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 661,
        folder: r"SQLITE_PARITY_661_JOIN_SUBQUERY_EXISTS_054",
        name: r"JOIN_SUBQUERY_EXISTS_054",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_054.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_1098_INDEX_SCHEMA_PRAGMA_031

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1098,
        folder: r"SQLITE_PARITY_1098_INDEX_SCHEMA_PRAGMA_031",
        name: r"INDEX_SCHEMA_PRAGMA_031",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_031.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',31),(2,'two',32),(3,'three',33),(4,'four',34);

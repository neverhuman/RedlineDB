...
// Source: SQLITE_PARITY_1122_INDEX_SCHEMA_PRAGMA_055

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1122,
        folder: r"SQLITE_PARITY_1122_INDEX_SCHEMA_PRAGMA_055",
        name: r"INDEX_SCHEMA_PRAGMA_055",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_055.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',55),(2,'two',56),(3,'three',57),(4,'four',58);

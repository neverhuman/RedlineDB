...
// Source: SQLITE_PARITY_506_DML_WHERE_ORDER_LIMIT_119

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 506,
        folder: r"SQLITE_PARITY_506_DML_WHERE_ORDER_LIMIT_119",
        name: r"DML_WHERE_ORDER_LIMIT_119",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_119.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_658_JOIN_SUBQUERY_EXISTS_051

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 658,
        folder: r"SQLITE_PARITY_658_JOIN_SUBQUERY_EXISTS_051",
        name: r"JOIN_SUBQUERY_EXISTS_051",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_051.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

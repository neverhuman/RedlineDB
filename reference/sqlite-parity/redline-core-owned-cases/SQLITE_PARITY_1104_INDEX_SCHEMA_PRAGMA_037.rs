...
// Source: SQLITE_PARITY_1104_INDEX_SCHEMA_PRAGMA_037

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1104,
        folder: r"SQLITE_PARITY_1104_INDEX_SCHEMA_PRAGMA_037",
        name: r"INDEX_SCHEMA_PRAGMA_037",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_037.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',37),(2,'two',38),(3,'three',39),(4,'four',40);

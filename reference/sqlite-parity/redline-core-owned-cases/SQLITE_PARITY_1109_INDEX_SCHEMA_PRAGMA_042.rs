...
// Source: SQLITE_PARITY_1109_INDEX_SCHEMA_PRAGMA_042

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1109,
        folder: r"SQLITE_PARITY_1109_INDEX_SCHEMA_PRAGMA_042",
        name: r"INDEX_SCHEMA_PRAGMA_042",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_042.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',42),(2,'two',43),(3,'three',44),(4,'four',45);

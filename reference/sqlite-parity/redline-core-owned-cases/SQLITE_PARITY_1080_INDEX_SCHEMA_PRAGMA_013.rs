...
// Source: SQLITE_PARITY_1080_INDEX_SCHEMA_PRAGMA_013

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1080,
        folder: r"SQLITE_PARITY_1080_INDEX_SCHEMA_PRAGMA_013",
        name: r"INDEX_SCHEMA_PRAGMA_013",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_013.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',13),(2,'two',14),(3,'three',15),(4,'four',16);

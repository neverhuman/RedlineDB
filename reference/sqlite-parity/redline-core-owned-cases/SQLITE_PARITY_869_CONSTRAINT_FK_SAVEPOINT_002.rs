...
// Source: SQLITE_PARITY_869_CONSTRAINT_FK_SAVEPOINT_002

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 869,
        folder: r"SQLITE_PARITY_869_CONSTRAINT_FK_SAVEPOINT_002",
        name: r"CONSTRAINT_FK_SAVEPOINT_002",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_002.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_1093_INDEX_SCHEMA_PRAGMA_026

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1093,
        folder: r"SQLITE_PARITY_1093_INDEX_SCHEMA_PRAGMA_026",
        name: r"INDEX_SCHEMA_PRAGMA_026",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_026.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',26),(2,'two',27),(3,'three',28),(4,'four',29);

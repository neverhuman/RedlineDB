...
// Source: SQLITE_PARITY_647_JOIN_SUBQUERY_EXISTS_040

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 647,
        folder: r"SQLITE_PARITY_647_JOIN_SUBQUERY_EXISTS_040",
        name: r"JOIN_SUBQUERY_EXISTS_040",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_040.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

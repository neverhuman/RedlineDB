...
// Source: SQLITE_PARITY_1087_INDEX_SCHEMA_PRAGMA_020

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1087,
        folder: r"SQLITE_PARITY_1087_INDEX_SCHEMA_PRAGMA_020",
        name: r"INDEX_SCHEMA_PRAGMA_020",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_020.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',20),(2,'two',21),(3,'three',22),(4,'four',23);

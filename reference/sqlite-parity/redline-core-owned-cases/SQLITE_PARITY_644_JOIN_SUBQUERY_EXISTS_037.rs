...
// Source: SQLITE_PARITY_644_JOIN_SUBQUERY_EXISTS_037

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 644,
        folder: r"SQLITE_PARITY_644_JOIN_SUBQUERY_EXISTS_037",
        name: r"JOIN_SUBQUERY_EXISTS_037",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_037.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

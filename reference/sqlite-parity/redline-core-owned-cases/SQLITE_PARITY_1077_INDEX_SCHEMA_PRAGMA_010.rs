...
// Source: SQLITE_PARITY_1077_INDEX_SCHEMA_PRAGMA_010

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1077,
        folder: r"SQLITE_PARITY_1077_INDEX_SCHEMA_PRAGMA_010",
        name: r"INDEX_SCHEMA_PRAGMA_010",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_010.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',10),(2,'two',11),(3,'three',12),(4,'four',13);

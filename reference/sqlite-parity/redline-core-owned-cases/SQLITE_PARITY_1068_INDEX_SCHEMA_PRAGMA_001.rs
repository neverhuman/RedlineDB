...
// Source: SQLITE_PARITY_1068_INDEX_SCHEMA_PRAGMA_001

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1068,
        folder: r"SQLITE_PARITY_1068_INDEX_SCHEMA_PRAGMA_001",
        name: r"INDEX_SCHEMA_PRAGMA_001",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_001.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',1),(2,'two',2),(3,'three',3),(4,'four',4);

...
// Source: SQLITE_PARITY_1120_INDEX_SCHEMA_PRAGMA_053

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1120,
        folder: r"SQLITE_PARITY_1120_INDEX_SCHEMA_PRAGMA_053",
        name: r"INDEX_SCHEMA_PRAGMA_053",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_053.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',53),(2,'two',54),(3,'three',55),(4,'four',56);

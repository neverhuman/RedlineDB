...
// Source: SQLITE_PARITY_952_VIEW_TRIGGER_GENERATED_005

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 952,
        folder: r"SQLITE_PARITY_952_VIEW_TRIGGER_GENERATED_005",
        name: r"VIEW_TRIGGER_GENERATED_005",
        category: r"GEN_SQL_VIEW_TRIGGER",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for VIEW_TRIGGER_GENERATED_005.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t(id,x) VALUES (1,5),(2,6);
CREATE VIEW v AS SELECT id, y FROM t WHERE y >= 10;

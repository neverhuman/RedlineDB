...
// Source: SQLITE_PARITY_608_JOIN_SUBQUERY_EXISTS_001

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 608,
        folder: r"SQLITE_PARITY_608_JOIN_SUBQUERY_EXISTS_001",
        name: r"JOIN_SUBQUERY_EXISTS_001",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_001.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_897_CONSTRAINT_FK_SAVEPOINT_030

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 897,
        folder: r"SQLITE_PARITY_897_CONSTRAINT_FK_SAVEPOINT_030",
        name: r"CONSTRAINT_FK_SAVEPOINT_030",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_030.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_1070_INDEX_SCHEMA_PRAGMA_003

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1070,
        folder: r"SQLITE_PARITY_1070_INDEX_SCHEMA_PRAGMA_003",
        name: r"INDEX_SCHEMA_PRAGMA_003",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_003.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',3),(2,'two',4),(3,'three',5),(4,'four',6);

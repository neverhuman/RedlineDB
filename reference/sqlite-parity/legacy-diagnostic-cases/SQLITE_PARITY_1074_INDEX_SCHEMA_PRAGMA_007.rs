...
// Source: SQLITE_PARITY_1074_INDEX_SCHEMA_PRAGMA_007

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1074,
        folder: r"SQLITE_PARITY_1074_INDEX_SCHEMA_PRAGMA_007",
        name: r"INDEX_SCHEMA_PRAGMA_007",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_007.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',7),(2,'two',8),(3,'three',9),(4,'four',10);

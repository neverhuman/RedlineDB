...
// Source: SQLITE_PARITY_891_CONSTRAINT_FK_SAVEPOINT_024

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 891,
        folder: r"SQLITE_PARITY_891_CONSTRAINT_FK_SAVEPOINT_024",
        name: r"CONSTRAINT_FK_SAVEPOINT_024",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_024.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

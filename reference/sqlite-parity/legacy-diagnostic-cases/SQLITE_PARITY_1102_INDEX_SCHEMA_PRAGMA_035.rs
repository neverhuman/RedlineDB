...
// Source: SQLITE_PARITY_1102_INDEX_SCHEMA_PRAGMA_035

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1102,
        folder: r"SQLITE_PARITY_1102_INDEX_SCHEMA_PRAGMA_035",
        name: r"INDEX_SCHEMA_PRAGMA_035",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_035.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',35),(2,'two',36),(3,'three',37),(4,'four',38);

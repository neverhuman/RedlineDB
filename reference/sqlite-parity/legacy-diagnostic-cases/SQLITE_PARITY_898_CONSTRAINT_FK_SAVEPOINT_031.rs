...
// Source: SQLITE_PARITY_898_CONSTRAINT_FK_SAVEPOINT_031

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 898,
        folder: r"SQLITE_PARITY_898_CONSTRAINT_FK_SAVEPOINT_031",
        name: r"CONSTRAINT_FK_SAVEPOINT_031",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_031.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

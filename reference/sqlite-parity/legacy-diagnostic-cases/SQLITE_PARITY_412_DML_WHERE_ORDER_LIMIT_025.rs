...
// Source: SQLITE_PARITY_412_DML_WHERE_ORDER_LIMIT_025

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 412,
        folder: r"SQLITE_PARITY_412_DML_WHERE_ORDER_LIMIT_025",
        name: r"DML_WHERE_ORDER_LIMIT_025",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_025.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

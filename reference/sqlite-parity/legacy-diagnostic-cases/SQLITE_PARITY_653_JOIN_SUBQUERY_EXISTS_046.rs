...
// Source: SQLITE_PARITY_653_JOIN_SUBQUERY_EXISTS_046

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 653,
        folder: r"SQLITE_PARITY_653_JOIN_SUBQUERY_EXISTS_046",
        name: r"JOIN_SUBQUERY_EXISTS_046",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_046.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

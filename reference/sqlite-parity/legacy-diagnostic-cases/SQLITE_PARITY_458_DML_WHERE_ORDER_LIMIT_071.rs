...
// Source: SQLITE_PARITY_458_DML_WHERE_ORDER_LIMIT_071

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 458,
        folder: r"SQLITE_PARITY_458_DML_WHERE_ORDER_LIMIT_071",
        name: r"DML_WHERE_ORDER_LIMIT_071",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_071.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

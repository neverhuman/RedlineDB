...
// Source: SQLITE_PARITY_1114_INDEX_SCHEMA_PRAGMA_047

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1114,
        folder: r"SQLITE_PARITY_1114_INDEX_SCHEMA_PRAGMA_047",
        name: r"INDEX_SCHEMA_PRAGMA_047",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_047.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',47),(2,'two',48),(3,'three',49),(4,'four',50);

...
// Source: SQLITE_PARITY_878_CONSTRAINT_FK_SAVEPOINT_011

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 878,
        folder: r"SQLITE_PARITY_878_CONSTRAINT_FK_SAVEPOINT_011",
        name: r"CONSTRAINT_FK_SAVEPOINT_011",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_011.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

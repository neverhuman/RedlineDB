...
// Source: SQLITE_PARITY_883_CONSTRAINT_FK_SAVEPOINT_016

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 883,
        folder: r"SQLITE_PARITY_883_CONSTRAINT_FK_SAVEPOINT_016",
        name: r"CONSTRAINT_FK_SAVEPOINT_016",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_016.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_1107_INDEX_SCHEMA_PRAGMA_040

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1107,
        folder: r"SQLITE_PARITY_1107_INDEX_SCHEMA_PRAGMA_040",
        name: r"INDEX_SCHEMA_PRAGMA_040",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_040.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',40),(2,'two',41),(3,'three',42),(4,'four',43);

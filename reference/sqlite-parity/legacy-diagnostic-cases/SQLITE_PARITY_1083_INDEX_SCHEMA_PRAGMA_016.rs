...
// Source: SQLITE_PARITY_1083_INDEX_SCHEMA_PRAGMA_016

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1083,
        folder: r"SQLITE_PARITY_1083_INDEX_SCHEMA_PRAGMA_016",
        name: r"INDEX_SCHEMA_PRAGMA_016",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_016.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',16),(2,'two',17),(3,'three',18),(4,'four',19);

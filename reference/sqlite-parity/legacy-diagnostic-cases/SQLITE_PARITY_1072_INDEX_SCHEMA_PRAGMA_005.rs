...
// Source: SQLITE_PARITY_1072_INDEX_SCHEMA_PRAGMA_005

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1072,
        folder: r"SQLITE_PARITY_1072_INDEX_SCHEMA_PRAGMA_005",
        name: r"INDEX_SCHEMA_PRAGMA_005",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_005.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',5),(2,'two',6),(3,'three',7),(4,'four',8);

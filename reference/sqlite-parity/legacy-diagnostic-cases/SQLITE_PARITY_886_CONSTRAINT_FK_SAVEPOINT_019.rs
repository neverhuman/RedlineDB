...
// Source: SQLITE_PARITY_886_CONSTRAINT_FK_SAVEPOINT_019

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 886,
        folder: r"SQLITE_PARITY_886_CONSTRAINT_FK_SAVEPOINT_019",
        name: r"CONSTRAINT_FK_SAVEPOINT_019",
        category: r"GEN_SQL_CONSTRAINT_TX",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for CONSTRAINT_FK_SAVEPOINT_019.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

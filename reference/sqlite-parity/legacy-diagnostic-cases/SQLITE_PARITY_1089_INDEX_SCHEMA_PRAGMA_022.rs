...
// Source: SQLITE_PARITY_1089_INDEX_SCHEMA_PRAGMA_022

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1089,
        folder: r"SQLITE_PARITY_1089_INDEX_SCHEMA_PRAGMA_022",
        name: r"INDEX_SCHEMA_PRAGMA_022",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_022.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',22),(2,'two',23),(3,'three',24),(4,'four',25);

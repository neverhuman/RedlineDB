...
// Source: SQLITE_PARITY_1096_INDEX_SCHEMA_PRAGMA_029

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1096,
        folder: r"SQLITE_PARITY_1096_INDEX_SCHEMA_PRAGMA_029",
        name: r"INDEX_SCHEMA_PRAGMA_029",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_029.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',29),(2,'two',30),(3,'three',31),(4,'four',32);

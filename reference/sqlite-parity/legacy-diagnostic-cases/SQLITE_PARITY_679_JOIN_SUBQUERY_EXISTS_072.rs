...
// Source: SQLITE_PARITY_679_JOIN_SUBQUERY_EXISTS_072

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 679,
        folder: r"SQLITE_PARITY_679_JOIN_SUBQUERY_EXISTS_072",
        name: r"JOIN_SUBQUERY_EXISTS_072",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_072.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

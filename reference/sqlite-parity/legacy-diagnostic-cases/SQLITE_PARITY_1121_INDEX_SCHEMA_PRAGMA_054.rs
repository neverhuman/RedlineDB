...
// Source: SQLITE_PARITY_1121_INDEX_SCHEMA_PRAGMA_054

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1121,
        folder: r"SQLITE_PARITY_1121_INDEX_SCHEMA_PRAGMA_054",
        name: r"INDEX_SCHEMA_PRAGMA_054",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_054.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',54),(2,'two',55),(3,'three',56),(4,'four',57);

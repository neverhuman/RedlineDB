...
// Source: SQLITE_PARITY_1118_INDEX_SCHEMA_PRAGMA_051

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1118,
        folder: r"SQLITE_PARITY_1118_INDEX_SCHEMA_PRAGMA_051",
        name: r"INDEX_SCHEMA_PRAGMA_051",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_051.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',51),(2,'two',52),(3,'three',53),(4,'four',54);

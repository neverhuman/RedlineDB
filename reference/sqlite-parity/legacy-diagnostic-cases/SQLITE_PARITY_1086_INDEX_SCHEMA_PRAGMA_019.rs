...
// Source: SQLITE_PARITY_1086_INDEX_SCHEMA_PRAGMA_019

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1086,
        folder: r"SQLITE_PARITY_1086_INDEX_SCHEMA_PRAGMA_019",
        name: r"INDEX_SCHEMA_PRAGMA_019",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_019.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',19),(2,'two',20),(3,'three',21),(4,'four',22);

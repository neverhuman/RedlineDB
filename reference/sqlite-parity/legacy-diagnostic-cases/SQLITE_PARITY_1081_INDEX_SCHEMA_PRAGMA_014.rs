...
// Source: SQLITE_PARITY_1081_INDEX_SCHEMA_PRAGMA_014

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1081,
        folder: r"SQLITE_PARITY_1081_INDEX_SCHEMA_PRAGMA_014",
        name: r"INDEX_SCHEMA_PRAGMA_014",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_014.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',14),(2,'two',15),(3,'three',16),(4,'four',17);

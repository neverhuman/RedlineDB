...
// Source: SQLITE_PARITY_1088_INDEX_SCHEMA_PRAGMA_021

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1088,
        folder: r"SQLITE_PARITY_1088_INDEX_SCHEMA_PRAGMA_021",
        name: r"INDEX_SCHEMA_PRAGMA_021",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_021.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',21),(2,'two',22),(3,'three',23),(4,'four',24);

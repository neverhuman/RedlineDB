...
// Source: SQLITE_PARITY_690_JOIN_SUBQUERY_EXISTS_083

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 690,
        folder: r"SQLITE_PARITY_690_JOIN_SUBQUERY_EXISTS_083",
        name: r"JOIN_SUBQUERY_EXISTS_083",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_083.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

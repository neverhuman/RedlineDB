...
// Source: SQLITE_PARITY_1125_INDEX_SCHEMA_PRAGMA_058

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1125,
        folder: r"SQLITE_PARITY_1125_INDEX_SCHEMA_PRAGMA_058",
        name: r"INDEX_SCHEMA_PRAGMA_058",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_058.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',58),(2,'two',59),(3,'three',60),(4,'four',61);

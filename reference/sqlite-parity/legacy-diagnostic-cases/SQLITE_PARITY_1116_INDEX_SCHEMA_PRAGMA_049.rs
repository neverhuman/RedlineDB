...
// Source: SQLITE_PARITY_1116_INDEX_SCHEMA_PRAGMA_049

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1116,
        folder: r"SQLITE_PARITY_1116_INDEX_SCHEMA_PRAGMA_049",
        name: r"INDEX_SCHEMA_PRAGMA_049",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_049.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',49),(2,'two',50),(3,'three',51),(4,'four',52);

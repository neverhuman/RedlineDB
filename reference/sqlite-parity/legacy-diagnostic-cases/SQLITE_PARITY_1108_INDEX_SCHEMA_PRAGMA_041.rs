...
// Source: SQLITE_PARITY_1108_INDEX_SCHEMA_PRAGMA_041

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1108,
        folder: r"SQLITE_PARITY_1108_INDEX_SCHEMA_PRAGMA_041",
        name: r"INDEX_SCHEMA_PRAGMA_041",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_041.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',41),(2,'two',42),(3,'three',43),(4,'four',44);

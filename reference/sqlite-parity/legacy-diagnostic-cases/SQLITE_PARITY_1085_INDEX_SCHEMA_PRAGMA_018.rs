...
// Source: SQLITE_PARITY_1085_INDEX_SCHEMA_PRAGMA_018

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1085,
        folder: r"SQLITE_PARITY_1085_INDEX_SCHEMA_PRAGMA_018",
        name: r"INDEX_SCHEMA_PRAGMA_018",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_018.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',18),(2,'two',19),(3,'three',20),(4,'four',21);

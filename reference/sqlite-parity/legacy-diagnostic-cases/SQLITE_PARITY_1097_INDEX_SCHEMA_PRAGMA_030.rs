...
// Source: SQLITE_PARITY_1097_INDEX_SCHEMA_PRAGMA_030

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1097,
        folder: r"SQLITE_PARITY_1097_INDEX_SCHEMA_PRAGMA_030",
        name: r"INDEX_SCHEMA_PRAGMA_030",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_030.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',30),(2,'two',31),(3,'three',32),(4,'four',33);

...
// Source: SQLITE_PARITY_621_JOIN_SUBQUERY_EXISTS_014

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 621,
        folder: r"SQLITE_PARITY_621_JOIN_SUBQUERY_EXISTS_014",
        name: r"JOIN_SUBQUERY_EXISTS_014",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_014.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

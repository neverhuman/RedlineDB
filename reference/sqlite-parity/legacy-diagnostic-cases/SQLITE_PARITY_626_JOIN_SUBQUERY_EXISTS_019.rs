...
// Source: SQLITE_PARITY_626_JOIN_SUBQUERY_EXISTS_019

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 626,
        folder: r"SQLITE_PARITY_626_JOIN_SUBQUERY_EXISTS_019",
        name: r"JOIN_SUBQUERY_EXISTS_019",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_019.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

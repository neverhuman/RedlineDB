...
// Source: SQLITE_PARITY_648_JOIN_SUBQUERY_EXISTS_041

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 648,
        folder: r"SQLITE_PARITY_648_JOIN_SUBQUERY_EXISTS_041",
        name: r"JOIN_SUBQUERY_EXISTS_041",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_041.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

...
// Source: SQLITE_PARITY_662_JOIN_SUBQUERY_EXISTS_055

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 662,
        folder: r"SQLITE_PARITY_662_JOIN_SUBQUERY_EXISTS_055",
        name: r"JOIN_SUBQUERY_EXISTS_055",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_055.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

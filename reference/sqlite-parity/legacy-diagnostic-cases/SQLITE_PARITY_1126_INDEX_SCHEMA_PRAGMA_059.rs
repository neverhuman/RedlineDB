...
// Source: SQLITE_PARITY_1126_INDEX_SCHEMA_PRAGMA_059

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1126,
        folder: r"SQLITE_PARITY_1126_INDEX_SCHEMA_PRAGMA_059",
        name: r"INDEX_SCHEMA_PRAGMA_059",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_059.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',59),(2,'two',60),(3,'three',61),(4,'four',62);

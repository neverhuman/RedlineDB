...
// Source: SQLITE_PARITY_698_JOIN_SUBQUERY_EXISTS_091

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 698,
        folder: r"SQLITE_PARITY_698_JOIN_SUBQUERY_EXISTS_091",
        name: r"JOIN_SUBQUERY_EXISTS_091",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_091.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

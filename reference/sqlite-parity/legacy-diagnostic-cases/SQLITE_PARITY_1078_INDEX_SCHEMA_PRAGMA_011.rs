...
// Source: SQLITE_PARITY_1078_INDEX_SCHEMA_PRAGMA_011

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1078,
        folder: r"SQLITE_PARITY_1078_INDEX_SCHEMA_PRAGMA_011",
        name: r"INDEX_SCHEMA_PRAGMA_011",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_011.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',11),(2,'two',12),(3,'three',13),(4,'four',14);

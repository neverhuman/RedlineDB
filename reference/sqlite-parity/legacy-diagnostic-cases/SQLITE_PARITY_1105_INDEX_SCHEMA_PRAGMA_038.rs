...
// Source: SQLITE_PARITY_1105_INDEX_SCHEMA_PRAGMA_038

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1105,
        folder: r"SQLITE_PARITY_1105_INDEX_SCHEMA_PRAGMA_038",
        name: r"INDEX_SCHEMA_PRAGMA_038",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_038.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',38),(2,'two',39),(3,'three',40),(4,'four',41);

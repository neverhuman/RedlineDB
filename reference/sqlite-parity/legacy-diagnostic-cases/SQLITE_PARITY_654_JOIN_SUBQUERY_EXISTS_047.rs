...
// Source: SQLITE_PARITY_654_JOIN_SUBQUERY_EXISTS_047

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 654,
        folder: r"SQLITE_PARITY_654_JOIN_SUBQUERY_EXISTS_047",
        name: r"JOIN_SUBQUERY_EXISTS_047",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_047.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO b VALUES (1,1,'b1'),(2,1,'b2'),(3,3,'b3'),(4,4,'bn');

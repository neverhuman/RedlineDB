...
// Source: SQLITE_PARITY_468_DML_WHERE_ORDER_LIMIT_081

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 468,
        folder: r"SQLITE_PARITY_468_DML_WHERE_ORDER_LIMIT_081",
        name: r"DML_WHERE_ORDER_LIMIT_081",
        category: r"GEN_SQL_DML",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for DML_WHERE_ORDER_LIMIT_081.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

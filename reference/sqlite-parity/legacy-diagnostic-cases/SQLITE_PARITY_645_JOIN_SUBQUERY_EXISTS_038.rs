...
// Source: SQLITE_PARITY_645_JOIN_SUBQUERY_EXISTS_038

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 645,
        folder: r"SQLITE_PARITY_645_JOIN_SUBQUERY_EXISTS_038",
        name: r"JOIN_SUBQUERY_EXISTS_038",
        category: r"GEN_SQL_JOIN_SUBQUERY",
        priority: r"P1",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for JOIN_SUBQUERY_EXISTS_038.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list

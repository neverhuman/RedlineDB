...
// Source: SQLITE_PARITY_1073_INDEX_SCHEMA_PRAGMA_006

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1073,
        folder: r"SQLITE_PARITY_1073_INDEX_SCHEMA_PRAGMA_006",
        name: r"INDEX_SCHEMA_PRAGMA_006",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_006.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',6),(2,'two',7),(3,'three',8),(4,'four',9);

...
// Source: SQLITE_PARITY_1123_INDEX_SCHEMA_PRAGMA_056

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1123,
        folder: r"SQLITE_PARITY_1123_INDEX_SCHEMA_PRAGMA_056",
        name: r"INDEX_SCHEMA_PRAGMA_056",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_056.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',56),(2,'two',57),(3,'three',58),(4,'four',59);

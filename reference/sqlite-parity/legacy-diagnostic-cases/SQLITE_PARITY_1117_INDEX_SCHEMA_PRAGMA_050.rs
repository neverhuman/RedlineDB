...
// Source: SQLITE_PARITY_1117_INDEX_SCHEMA_PRAGMA_050

pub fn case() -> crate::ParityCase {
    crate::ParityCase {
        id: 1117,
        folder: r"SQLITE_PARITY_1117_INDEX_SCHEMA_PRAGMA_050",
        name: r"INDEX_SCHEMA_PRAGMA_050",
        category: r"GEN_SQL_INDEX_PRAGMA",
        priority: r"P2",
        profile: r"memory",
        kind: r"sql-generated",
        description: r"Generated deterministic SQLite parity case for INDEX_SCHEMA_PRAGMA_050.",
        status: r"active",
        db: r":memory:",
        args: &[],
        stdin: r".mode list
...
INSERT INTO t VALUES (1,'one',50),(2,'two',51),(3,'three',52),(4,'four',53);

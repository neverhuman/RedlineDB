...
- `docs/release-evidence/10.0.0/`: committed lifecycle evidence, including one
  `authority-binds-*.md` record per bind batch with each member's exact
  identity and reviewed-route provenance.

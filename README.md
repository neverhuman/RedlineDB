...
**SQLite parity latency:** median gap **-52.23%**, worst gap **-29680.51%**, faster cases **301**.
...
| ---: | --- | --- | --- | --- | ---: | ---: | ---: |
| 1 | CASE_COALESCE_NULLIF_IIF | P0 | memory | SQL_EXPRESSIONS | 2080083 | 893415201 | -29680.51% |
| 2 | DOT_VFSNAME_LIST_INFO | P3 | memory | CLI_DOT_COMMAND_DIAGNOSTIC | 2178820 | 649733938 | -21557.80% |
| 3 | SELECT_CORE_EXPRESSIONS | P0 | memory | SQL_SELECT | 3156730 | 673018738 | -21220.12% |
| 4 | STRICT_TABLE | P0 | memory | SQL_DDL | 2892420 | 593563717 | -19685.46% |
| 5 | ROWID_INTEGER_PRIMARY_KEY | P0 | memory | SQL_ROWID | 4207977 | 810163852 | -19153.05% |
| 6 | SELECT_DISTINCT | P0 | memory | SQL_SELECT | 2863605 | 568486837 | -18849.56% |
| 7 | PRAGMA_TEMP_STORE_MEMORY | P0 | memory | SQL_PRAGMA | 3469050 | 630928054 | -18087.34% |
| 8 | NOT_INDEXED | P0 | memory | SQL_INDEX | 3256598 | 555698995 | -16963.79% |
| 9 | CREATE_TRIGGER_BEFORE | P0 | memory | SQL_TRIGGER | 3365084 | 536369181 | -15839.25% |
| 10 | NOT_NULL_FAILURE | P0 | memory | SQL_CONSTRAINTS_NEGATIVE | 5006557 | 789663405 | -15672.58% |
| 11 | MATH_FUNCTIONS_OPTIONAL | P2 | memory | SQL_FUNCTIONS_OPTIONAL | 3165065 | 494206060 | -15514.40% |
| 12 | DOT_OPEN_MEMORY | P0 | memory | CLI_DOT_COMMAND | 3930703 | 609926931 | -15416.99% |
| 13 | ANALYZE_SQLITE_STAT1 | P0 | memory | SQL_ANALYZE | 5844873 | 905275620 | -15388.37% |
| 14 | BETWEEN_IN_ISNULL_IS | P0 | memory | SQL_OPERATORS | 4213778 | 645879617 | -15227.80% |
| 15 | INDEXED_BY | P0 | memory | SQL_INDEX | 4407104 | 669438157 | -15089.98% |
| 16 | DOT_CONNECTION | P0 | memory | CLI_DOT_COMMAND | 4211344 | 630072799 | -14861.32% |
| 17 | CLI_UINT_COLLATION_OPTIONAL | P3 | memory | CLI_EXTENSION_OPTIONAL | 3020903 | 451553694 | -14847.64% |
| 18 | CLI_REGEXP_OPTIONAL | P2 | memory | CLI_EXTENSION_OPTIONAL | 4458601 | 664894817 | -14812.63% |
| 19 | DOT_TRACE_STDOUT | P2 | memory | CLI_DOT_COMMAND_DIAGNOSTIC | 2990055 | 434303935 | -14376.80% |
| 20 | DOT_MODE_CSV_AND_QUOTE | P0 | memory | CLI_DOT_COMMAND | 3264433 | 452755146 | -13769.33% |
| 21 | WINDOW_ROW_NUMBER_RANK | P0 | memory | SQL_WINDOW | 7449928 | 1022942418 | -13630.90% |
| 22 | WINDOW_FRAMES_ROWS | P0 | memory | SQL_WINDOW | 3099692 | 419734434 | -13441.17% |
| 23 | DOT_CHANGES | P0 | memory | CLI_DOT_COMMAND | 4423806 | 594425898 | -13336.98% |
| 24 | CREATE_TABLE_AS_SELECT | P0 | memory | SQL_DDL | 5909886 | 792651886 | -13312.30% |
| 25 | PRAGMA_USER_VERSION | P0 | memory | SQL_PRAGMA | 2153132 | 401028260 | -13267.61% |

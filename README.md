...
**SQLite parity latency:** median gap **-86.07%**, worst gap **-39227.46%**, faster cases **218**.
...
| ---: | --- | --- | --- | --- | ---: | ---: | ---: |
| 1 | EXPLAIN_QUERY_PLAN | P0 | memory | SQL_EXPLAIN | 2924841 | 1179823876 | -39227.46% |
| 2 | DOT_OPEN_MEMORY | P0 | memory | CLI_DOT_COMMAND | 3210200 | 1045820818 | -32478.06% |
| 3 | GENERATED_COLUMNS | P0 | memory | SQL_DDL | 2654599 | 967884176 | -32162.81% |
| 4 | JSON_SCALAR_FUNCTIONS | P0 | memory | SQL_JSON | 2307694 | 929753058 | -30891.77% |
| 5 | COLLATE_NOCASE_RTRIM_BINARY | P0 | memory | SQL_COLLATION | 2943406 | 929394970 | -30879.83% |
| 6 | DOT_VFSNAME_LIST_INFO | P3 | memory | CLI_DOT_COMMAND_DIAGNOSTIC | 2490068 | 886440887 | -29448.03% |
| 7 | JOINS_RIGHT_FULL_OUTER | P0 | memory | SQL_JOIN | 2186785 | 870284542 | -28909.48% |
| 8 | CHECK_CONSTRAINT_FAILURE | P0 | memory | SQL_CONSTRAINTS_NEGATIVE | 2852895 | 867014683 | -28800.49% |
| 9 | DOT_IMPOSTER_CATALOG | P4 | catalog | CLI_CATALOG | 2009250 | 863783595 | -28692.79% |
| 10 | STRICT_TABLE | P0 | memory | SQL_DDL | 2656503 | 862040908 | -28634.70% |
| 11 | OPT_SAFE_MODE_BLOCKS_SHELL | P2 | memory | CLI_OPTION_NEGATIVE | 2960047 | 845559587 | -28085.32% |
| 12 | DATE_TIME_FUNCTIONS | P0 | memory | SQL_FUNCTIONS | 2651334 | 840422074 | -27914.07% |
| 13 | CORE_FORMAT_QUOTE_HEX | P0 | memory | SQL_FUNCTIONS | 2219266 | 838488356 | -27849.61% |
| 14 | ATTACH_DETACH_MEMORY | P0 | memory | SQL_ATTACH | 2648879 | 832301659 | -27643.39% |
| 15 | DOT_SESSION_CATALOG | P4 | catalog | CLI_CATALOG | 2775549 | 830573715 | -27585.79% |
| 16 | DOT_LIMIT | P0 | memory | CLI_DOT_COMMAND | 2729581 | 830469475 | -27582.32% |
| 17 | STRICT_TABLE_TYPE_FAILURE | P0 | memory | SQL_DDL_NEGATIVE | 3154425 | 847171637 | -26756.61% |
| 18 | DOT_DATABASES | P0 | memory | CLI_DOT_COMMAND | 3247901 | 860961624 | -26408.25% |
| 19 | UPSERT_DO_UPDATE | P0 | memory | SQL_UPSERT | 3129047 | 819593058 | -26093.06% |
| 20 | SCALAR_CAST_TYPEOF_005 | P1 | memory | GEN_SQL_SCALAR | 2566684 | 781364560 | -25945.49% |
| 21 | CORE_RANDOM_SHAPE | P0 | memory | SQL_FUNCTIONS | 3080184 | 798651528 | -25828.70% |
| 22 | FOREIGN_KEY_FAILURE | P0 | memory | SQL_FOREIGN_KEYS_NEGATIVE | 2883792 | 776530480 | -25784.35% |
| 23 | SCALAR_ARITH_001 | P1 | memory | GEN_SQL_SCALAR | 3353170 | 866199795 | -25732.27% |
| 24 | OPT_HTML_MODE | P2 | memory | CLI_OPTION | 2569399 | 767518070 | -25483.94% |
| 25 | DOT_FILECTRL_CATALOG | P4 | catalog | CLI_CATALOG | 2966810 | 767361110 | -25478.70% |

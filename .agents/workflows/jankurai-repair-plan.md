...
Use `jankurai repair-plan . --from agent/repo-score.json --out .jankurai/repair-plan.json --md .jankurai/repair-plan.md` to turn the latest report into bounded repair packets.

# Governed Jankurai 1.6.11 repair-plan
...
Use `bash ops/ci/run-jankurai.sh repair-plan . --from .jankurai/repo-score.json --out .jankurai/repair-plan.json --md .jankurai/repair-plan.md` to turn the latest report into bounded repair packets.
Expected receipts: `.jankurai/repair-plan.json`, `.jankurai/repair-plan.md`.
Next command: `bash ops/ci/run-jankurai.sh repair`.

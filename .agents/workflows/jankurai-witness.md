...
Use `jankurai witness . --changed-from origin/main --baseline .jankurai/baselines/main.repo-score.json --out target/jankurai/merge-witness.json --md target/jankurai/merge-witness.md` to compare the current branch against the accepted baseline.

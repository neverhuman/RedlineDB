# Governed Jankurai 1.6.11 witness
...
Use `bash ops/ci/run-jankurai.sh witness . --changed-from origin/main --baseline .jankurai/baselines/main.repo-score.json --out .jankurai/merge-witness.json --md .jankurai/merge-witness.md` to compare the current branch against the accepted baseline.
Expected receipts: `.jankurai/merge-witness.json`, `.jankurai/merge-witness.md`.
Next command: `bash ops/ci/run-jankurai.sh repair-plan`.

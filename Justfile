...
proof-routing:
    bash ops/ci/run-jankurai.sh proof . --changed-from "${JANKURAI_BASE_REF:-origin/main}" --out target/jankurai/proof-routing.json --md target/jankurai/proof-routing.md

proofbind:
    bash ops/ci/run-jankurai.sh proofbind verify . --changed-from "${JANKURAI_BASE_REF:-origin/main}" --out target/jankurai/proofbind/surface-witness.json --obligations-out target/jankurai/proofbind/obligations.json
...
authz-matrix:
    bash ops/ci/run-jankurai.sh audit . --mode advisory --json target/jankurai/authz-matrix.json --md target/jankurai/authz-matrix.md

input-boundary:
    bash ops/ci/run-jankurai.sh audit . --mode advisory --json target/jankurai/input-boundary.json --md target/jankurai/input-boundary.md

agent-tool-supply:
    bash ops/ci/run-jankurai.sh audit . --mode advisory --json target/jankurai/agent-tool-supply.json --md target/jankurai/agent-tool-supply.md

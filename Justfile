...
atomicsoul-dry-run:
  cd ../jain-deploy && ATOMICSOUL_PUSH=0 JAIN_RELEASE_VERSION=8.0.0 ./scripts/atomicsoul-dry-run.sh --evidence-dir ../jain-split-ops/docs/release-evidence/8.0.0/atomicsoul

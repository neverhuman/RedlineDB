...
bootstrap-main repo remote source_ref reviewed_commit reviewed_tree token_file:
  cargo run --locked --quiet -- bootstrap-main --repo "{{repo}}" --remote "{{remote}}" --source-ref "{{source_ref}}" --reviewed-commit "{{reviewed_commit}}" --reviewed-tree "{{reviewed_tree}}" --token-file "{{token_file}}"

bootstrap-main-apply repo remote source_ref reviewed_commit reviewed_tree token_file:
  cargo run --locked --quiet -- bootstrap-main --repo "{{repo}}" --remote "{{remote}}" --source-ref "{{source_ref}}" --reviewed-commit "{{reviewed_commit}}" --reviewed-tree "{{reviewed_tree}}" --token-file "{{token_file}}" --apply

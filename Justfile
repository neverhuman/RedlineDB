...
bootstrap-main repo remote reviewed_commit reviewed_tree:
  cargo run --locked --quiet -- bootstrap-main --repo "{{repo}}" --remote "{{remote}}" --reviewed-commit "{{reviewed_commit}}" --reviewed-tree "{{reviewed_tree}}"

bootstrap-main-apply repo remote reviewed_commit reviewed_tree token_file:
  cargo run --locked --quiet -- bootstrap-main --repo "{{repo}}" --remote "{{remote}}" --reviewed-commit "{{reviewed_commit}}" --reviewed-tree "{{reviewed_tree}}" --token-file "{{token_file}}" --apply
